"""Conformance of the machine-readable Component Contract of SCS-001 Slice 2.
...
single read is the prerequisite surface; the teacher discovery list is
the Slice 2 addition.
"""
...
def test_published_api_matches_the_implementation_in_both_directions():
    ...
    # Exactly the two business read operations plus health/readiness.
