...
- `ADR-0015 — Activate Level 2 Component Factory` — `RATIFIED` (2026-09-14). Активирует Level 2 — Component Factory после прохождения Factory Gate #1, при сохранении существующих бизнес-границ, владения данными, контрактных и compatibility-правил. Реализация фабричных механизмов выполняется инкрементально; первый отдельный implementation slice — Component Registry.
