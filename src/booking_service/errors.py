"""Error surface of the Booking component (SCS-003).
...
* :class:`ContractViolation` — this component's contract transport failed or
  ...
  of assuming a record was served;
...
class AccessRefused(Exception):
    """One refused access at the Booking enforcement boundary.
    ...
    and it can never be mistaken for a served record.
    """
