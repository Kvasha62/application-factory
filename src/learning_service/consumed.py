"""Local value types for what Learning consumes from the Authorization Boundary.

Learning depends on exactly one fact it does not own: *whether this
