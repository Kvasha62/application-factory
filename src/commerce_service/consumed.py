"""Local value types for what Commerce consumes from the platform boundaries.

Commerce depends on exactly one fact it does not own: *whether this
...
class TenantContextAnswer:
    ...
    Consumed for exactly one purpose: the create-product command has no
